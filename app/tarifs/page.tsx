...
const packs = [
  ...
  },
  {
    ...
    bgColor: '#185FA5',
    icon: '🔧',
    description: "Réparez votre vélo maintenant, et apprenez à le faire seul demain. Damien vous guide en visio et vous envoie un guide des 10 réparations essentielles après la séance.",
    features: [
      "Accompagnement visio",
      "Aide à la réparation en direct",
      "Guide des 10 réparations essentielles après la séance",
    ],
    highlight: true,
  },
  {
    ...
    bgColor: '#042C53',
    icon: '⭐',
    description: "Pour les réparations importantes et devenir pleinement autonome sur votre vélo.",
    features: [
      "Diagnostic complet de votre vélo",
      "Conseil en étude posturale",
      "Accompagnement à la réparation",
      "Guide complet pour devenir autonome sur toutes vos réparations",
    ],
    highlight: false,
  },
]
