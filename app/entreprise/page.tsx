  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F8FAFF', fontFamily: font }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #042C53 0%, #185FA5 100%)', padding: '64px 24px' }}>
        <div style={{ maxWidth: 720, margin: '0 auto', color: 'white', textAlign: 'center' }}>
          ...
          <h1 style={{ fontFamily: font, fontSize: 36, fontWeight: 800, lineHeight: 1.25, margin: '0 0 16px' }}>
            Un mécanicien vélo<br />dans votre entreprise
          </h1>
          <p style={{ color: '#B5D4F4', fontSize: 16, lineHeight: 1.7, margin: '0 auto 32px', maxWidth: 480 }}>
          ...
          <a href="#devis" style={{ display: 'inline-block', background: '#FAC775', color: '#042C53', padding: '14px 32px', borderRadius: 12, textDecoration: 'none', fontSize: 16, fontWeight: 800 }}>
            Demander un devis →
          </a>
        </div>
      </section>
      ...
      <section style={{ padding: '64px 24px', maxWidth: 1000, margin: '0 auto' }}>
        <h2 style={{ textAlign: 'center', color: '#042C53', fontWeight: 800, fontSize: 26, marginBottom: 48 }}>Comment ça se passe ?</h2>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(210px, 1fr))', gap: 24 }}>
          {[
            ...
            <div key={step.num} style={{ background: 'white', borderRadius: 16, padding: 28, border: '1px solid #E6F1FB', textAlign: 'center' }}>
              ...
              <h3 style={{ color: '#042C53', fontWeight: 700, fontSize: 15, marginBottom: 10 }}>{step.title}</h3>
      ...
      <section style={{ background: '#E6F1FB', padding: '64px 24px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <h2 style={{ textAlign: 'center', color: '#042C53', fontWeight: 800, fontSize: 26, marginBottom: 48 }}>Pourquoi faire appel à Doctobike ?</h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24 }}>
            {AVANTAGES.map((a, i) => (
              <div key={i} style={{ background: 'white', borderRadius: 16, padding: 28, border: '1px solid #B5D4F4', display: 'flex', gap: 16 }}>
                <div style={{ fontSize: 32, flexShrink: 0 }}>{a.icon}</div>
                <div>
                  <h3 style={{ color: '#042C53', fontWeight: 700, fontSize: 15, margin: '0 0 8px' }}>{a.title}</h3>
      ...
      <section id="devis" style={{ padding: '64px 24px', maxWidth: 640, margin: '0 auto' }}>
        <h2 style={{ textAlign: 'center', color: '#042C53', fontWeight: 800, fontSize: 26, marginBottom: 8 }}>Demander un devis</h2>
        ...
        {status === 'success' ? (
          <div style={{ background: 'white', borderRadius: 20, border: '1px solid #E6F1FB', padding: 40, textAlign: 'center' }}>
            <div style={{ fontSize: 48, marginBottom: 16 }}>✅</div>
            <h3 style={{ color: '#042C53', fontWeight: 800, fontSize: 20, marginBottom: 12 }}>Demande envoyée !</h3>
          ...
          <div style={{ background: 'white', borderRadius: 20, border: '1px solid #E6F1FB', padding: 32 }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>

              {/* Prénom / Nom */}
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
                <div>
                  <label style={labelStyle}>Prénom <span style={{ color: '#E24B4A' }}>*</span></label>
                  <input value={form.prenom} onChange={e => setForm({ ...form, prenom: e.target.value })}
                    placeholder="Marie" style={inputStyle} />
                </div>
                <div>
                  <label style={labelStyle}>Nom <span style={{ color: '#E24B4A' }}>*</span></label>
              ...
              {/* Email */}
              <div>
                <label style={labelStyle}>Email professionnel <span style={{ color: '#E24B4A' }}>*</span></label>
              ...
              {errorMsg && (
                <p style={{ color: '#A32D2D', background: '#FCEBEB', borderRadius: 8, padding: '10px 14px', fontSize: 13, margin: 0 }}>
                  {errorMsg}
                </p>
              )}

              <div style={{ background: '#FFF3CD', borderRadius: 10, padding: '12px 16px', fontSize: 13, color: '#854F0B', border: '1px solid #FAC775' }}>
              ...
              <button
                ...
                style={{
                  background: status === 'loading' ? '#aaa' : '#185FA5',
                  color: 'white',
                  border: 'none',
                  padding: '14px 24px',
                  borderRadius: 12,
      ...
      <footer style={{ background: '#042C53', padding: '32px 24px', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: 24, flexWrap: 'wrap' }}>
          <a href="/mentions-legales" style={{ color: '#378ADD', fontSize: 13, textDecoration: 'none' }}>Mentions légales</a>
          <a href="/cgv" style={{ color: '#378ADD', fontSize: 13, textDecoration: 'none' }}>CGV</a>
          <a href="/confidentialite" style={{ color: '#378ADD', fontSize: 13, textDecoration: 'none' }}>Confidentialité</a>
        </div>
      </footer>
